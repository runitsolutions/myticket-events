...
<table width="100%" cellpadding="0" cellspacing="0" >
	<tr class="top">
		...
		<td width="50%" style="text-align:right;">
			...
			// retrieve custom logo from WC product gallery
	...
	<?php foreach ( $line_items as $item_id => $item ) { ?>
		<tr class="item">
			<td width="50%">
				...
				<?php 
				/* use this code to display featured product image
				...
				*/
				...
				/* use this code to retrieve porduct gallery images
		...
		<tbody width="100%" style="text-align:center;">
			...
			<tr class="item">
				<td width="50%">
					...
					$seat 		= wc_get_order_item_meta( $item_id, "seat"); 	echo '<b>'.esc_html__( 'Seat:', 'myticket-events' )."</b> ".esc_html($seat)."<br>";
					$row 		= wc_get_order_item_meta( $item_id, "row"); 	echo '<b>'.esc_html__( 'Row:', 'myticket-events' )."</b> ".esc_html($row)."<br>";
					// custom zone fields defined under https://myticket.kenzap.cloud/
					// $row 		= wc_get_order_item_meta( $item_id, "cf1"); 	echo '<b>'.esc_html__( 'Gate:', 'myticket-events' )."</b> ".esc_html($row)."<br>";
