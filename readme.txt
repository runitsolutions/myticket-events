MyTicket Events
Contributors: kenzap, runit-solutions
...
**Note:** This is a fork of the original MyTicket Events plugin by Kenzap. This fork is now maintained by **RunIT Solutions**.

**Repository:** https://github.com/runitsolutions/myticket-events
...
= v2.0.0 =
New: Fork maintained by RunIT Solutions
Update: Removed CMB2 dependency - now uses native WordPress metaboxes
Update: Author changed from Kenzap to RunIT Solutions
Security: Fixed CVE-2025-27299 Path Traversal vulnerability
Security: Added nonce verification to all AJAX endpoints
Security: Fixed directory traversal vulnerability in template loading
Security: Added proper input validation and sanitization for file paths
Security: Fixed XSS vulnerabilities in user input handling
Security: Improved cookie handling with proper sanitization
Security: Added whitelist validation for template type values

= v1.2.4 =
Update: fixing woocommerce my account page, missing order details
Update: fixing some seats were already book error for pass type reservations
Update: fixing The PHP default time zone was changed after loading WordPress with a date_default_timezone_set () function call.
Update: fixing glitching pass selection dropdown element
Update: PHP 8.1 compatability improvements
Update: fixing "required parameter ... follows optional parameter ..." warning
Update: fixing MyTicket Hall layout saving problem.
...
= v1.2.3 =
Update: adding support for custom zone fields defined under https://myticket.kenzap.cloud/
Update: fixing issue with seat reservation across different layouts 
Update: more smooth seat reservation cart addition. Page refresh removed. 
Update: Uncaught TypeError fix for custom input fields
Update: refreshing .pot file
New: large layouts can be defined under theme/myticket-events/layouts folder
New: adding support for custom layout summary table. Table structure defined under theme/myticket-events/layouts folder
New: improved rendering time of hall layouts
New: adding price variations to individual zones
