...
function myticket_events_customizer_register( $wp_customize ) {
    ...
    $wp_customize->add_control( new MyTicket_Customizer_Repeater( $wp_customize, 'myticket_fields', array(
                                ...
                                'section' => 'myticket_checkout_section',
                                'priority' => 20,
                                'description' => esc_html__( 'Add additional cart checkout input fields. Fields can be passed to PDF tickets or email notifications.', 'myticket-events' ).' https://kenzap.blog/how-to-customize-pdf-ticket-with-myticket-events-plugin/',
                                'fields' => array(
